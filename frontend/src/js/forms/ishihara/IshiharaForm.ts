		...
		`<div>
			...
			<div class="center-content" style="flex-direction: column;">
				<div class="center-content" style="display: flex; width: 800px; flex-wrap: wrap">
					...
					<div>
						<img style="width: 300px; height: 300px;" src="images/ishihara2.jpg" alt="Failed to load image" />
						<p style="text-align: center;"><input type="text" /></p>
					</div>
					
					<div>
						<img style="width: 300px; height: 300px;" src="images/ishihara3.gif" alt="Failed to load image" />
						<p style="text-align: center;"><input type="text" /></p>
					</div>
					...
					<div>
						<img style="width: 300px; height: 300px;" src="images/ishihara4.jpg" alt="Failed to load image" />
						<p style="text-align: center;"><input type="text" /></p>
					</div>
				</div>
