...
var UserInterface_1 = require("./io/UserInterface");
var TestingComplete_1 = require("./forms/TestingComplete");
var PieChartData_1 = require("./tests/PieChart/PieChartData");
var Color_1 = require("./io/ui/Color");
var Point_1 = require("./PlotData/Point");
var LinearScaleNormalizer_1 = require("./PlotData/Normalization/LinearScaleNormalizer");
var IndependentAxisNormalizer_1 = require("./PlotData/Normalization/IndependentAxisNormalizer");
var PieChartDisplay_1 = require("./tests/PieChart/PieChartDisplay");
var PieChart_1 = require("./tests/PieChart/PieChart");
var EXAMPLE_PLANE_AXIS_LENGTH = 600;
var UI;
var testList;
var task;
var uiUpdateTimer;
$(function Main() {
    var linearNormalizer = new LinearScaleNormalizer_1.LinearScaleNormalizer();
    var axisNormalizer = new IndependentAxisNormalizer_1.IndependentAxisNormalizer();
    UI = new UserInterface_1.UserInterface();
    var waves = GenerateWaveGraph(40, EXAMPLE_PLANE_AXIS_LENGTH / 1.8, 13);
    var firstChart = RandomPiechart(6);
    var second = RandomPiechart(6);
    var task = new PieChart_1.PieChart(firstChart, second);
    task.SetPrompt("Do these pie charts represent the same data?");
    var display = new PieChartDisplay_1.PieChartDisplay(firstChart, second);
    task.SetDisplay(display);
    testList = new TaskList_1.TaskList([
        task,
    ]);
    ApplyPageEventHandlers();
    NextTask();
});
function GenerateWaveGraph(pointsPerSlice, dimension, multiplier) {
    if (multiplier === void 0) { multiplier = 1; }
    var points = [];
    var increment = 1 / pointsPerSlice;
    for (var x = 0; x <= 1; x += increment) {
        for (var z = 0; z <= 1; z += increment) {
            var screenY_1 = (Math.sin(x * multiplier) - Math.cos(z * multiplier)) * dimension;
            var screenX_1 = x * dimension - dimension / 2;
            var screenZ = z * dimension - dimension / 2;
            points.push(new Point_1.Point(screenX_1, screenY_1, screenZ));
        }
    }
    return new IndependentAxisNormalizer_1.IndependentAxisNormalizer().Normalize(points);
}
function RandomPiechart(numberOfSlices) {
    var MAX_VALUE = 6;
    var MIN_VALUE = 0;
    var result = [];
    for (var i = 0; i < 6; i++) {
        var value = Math.random() * (MAX_VALUE - MIN_VALUE) + MIN_VALUE;
        var colour = new Color_1.Color(Math.random() * 255, Math.random() * 255, Math.random() * 255, Math.random() * 0.5 + 0.5);
        result[i] = new PieChartData_1.PieChartData("" + i, value, colour);
    }
    return result;
}
function RandomPoints(numberOfPoints, min, max) {
    var points = [];
    for (var i = 0; i < numberOfPoints; i++) {
        points[i] = new Point_1.Point(randomValue(), randomValue(), randomValue());
    }
    return points;
...
function ApplyPracticeProperties(task) {
    var promptAppend = "&#9888; This is an example of the test you are about to do. Results of this test are not tracked.";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, task.WaitForCompletion()];
                case 1:
                    result = _a.sent();
...
function AllTestsCompleted() {
    DisplayTask(new TestingComplete_1.TestingComplete());
}
...
},{"./PlotData/Normalization/IndependentAxisNormalizer":34,"./PlotData/Normalization/LinearScaleNormalizer":35,"./PlotData/Point":36,"./forms/TestingComplete":37,"./io/UserInterface":39,"./io/ui/Color":41,"./tasks/TaskList":49,"./tests/PieChart/PieChart":52,"./tests/PieChart/PieChartData":53,"./tests/PieChart/PieChartDisplay":54}],34:[function(require,module,exports){
"use strict";
exports.__esModule = true;
exports.IndependentAxisNormalizer = void 0;
var Point_1 = require("../Point");
var IndependentAxisNormalizer = (function () {
    function IndependentAxisNormalizer() {
    }
    IndependentAxisNormalizer.prototype.Normalize = function (points) {
        ...
        for (var i = 0; i < points.length; i++) {
            ...
            if (absZ > highestZ)
                highestZ = absZ;
            normalizedPoints[i] = new Point_1.Point(point.X, point.Y, point.Z);
        }
...
},{"../Point":36}],35:[function(require,module,exports){
"use strict";
exports.__esModule = true;
exports.LinearScaleNormalizer = void 0;
var Point_1 = require("../Point");
var LinearScaleNormalizer = (function () {
    function LinearScaleNormalizer() {
    }
    LinearScaleNormalizer.prototype.Normalize = function (points) {
        var normalizedPoints = [];
        var highestAxisValue = -Infinity;
        for (var i = 0; i < points.length; i++) {
            var point = points[i];
            var absX = Math.abs(point.X);
            var absY = Math.abs(point.Y);
    ...
    return LinearScaleNormalizer;
}());
exports.LinearScaleNormalizer = LinearScaleNormalizer;
...
exports.__esModule = true;
exports.TestingComplete = void 0;
var tasks_1 = require("../tasks");
var io_1 = require("../io");
var metrics_1 = require("../metrics");
var TestingComplete = (function (_super) {
    __extends(TestingComplete, _super);
    function TestingComplete() {
        return _super.call(this) || this;
    }
    TestingComplete.prototype.Submit = function (selectedOptions) {
        throw new Error("Method not implemented.");
    };
    TestingComplete.prototype.GetOptions = function () {
        return [];
    };
    TestingComplete.prototype.GetDisplay = function () {
        return new TestingCompleteDisplay();
    };
    TestingComplete.prototype.GetTimer = function () {
        return new metrics_1.UnlimitedTimer();
    };
    return TestingComplete;
}(tasks_1.Task));
exports.TestingComplete = TestingComplete;
var TestingCompleteDisplay = (function (_super) {
    __extends(TestingCompleteDisplay, _super);
    function TestingCompleteDisplay() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TestingCompleteDisplay.prototype.Display = function (screen) {
        screen.ViewModeTestsComplete();
    };
    return TestingCompleteDisplay;
}(io_1.TaskDisplay));
},{"../io":40,"../metrics":42,"../tasks":51}],38:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
var UserInterface = (function () {
    ...
    UserInterface.prototype.SetTitle = function (title) {
        this.titleContainer.html(title);
    };
    UserInterface.prototype.SetPrompt = function (prompt) {
        this.promptContainer.html(prompt);
    };
    UserInterface.prototype.SetTimerProgress = function (progress) {
        this.timerBar.css("width", progress + "%");
    };
    UserInterface.prototype.ShowOptions = function (task) {
        this.optionsContainer.html("");
        var options = task.GetOptions();
        var _loop_1 = function (i) {
            var option = options[i];
            var template = options[i].Template();
            var element = $(template);
            element.prop("data-option-id", option.Id);
            element.click(function () {
                task.Submit(option);
            });
            this_1.optionsContainer.append(element);
        };
        var this_1 = this;
    ...
    UserInterface.prototype.ContentContainer = function () {
        return this.contentContainer;
    };
    UserInterface.prototype.OriginalViewContainer = function () {
        return this.originalView;
    };
    UserInterface.prototype.ComparisonViewContainer = function () {
        return this.comparisonView;
    };
    UserInterface.prototype.PromptContainer = function () {
        return this.promptContainer;
    };
    UserInterface.prototype.ViewModeComparison = function () {
        this.contentContainer.hide();
        this.completionContainer.hide();
        this.comparisonContainer.show();
    };
    UserInterface.prototype.ViewModeContent = function () {
        this.comparisonContainer.hide();
        this.completionContainer.hide();
        this.contentContainer.show();
    };
    UserInterface.prototype.ViewModeTestsComplete = function () {
        this.comparisonContainer.hide();
        this.contentContainer.hide();
        this.completionContainer.show();
    };
    UserInterface.prototype.ClearView = function () {
        this.originalView.html("");
        this.comparisonView.html("");
        this.contentContainer.html("");
        this.promptContainer.html("");
    };
    UserInterface.prototype.ShowSubmitButton = function () {
        this.submitButton.show();
    };
    UserInterface.prototype.HideSubmitButton = function () {
...
"use strict";
exports.__esModule = true;
exports.TaskDisplay = exports.UserInterface = void 0;
...
},{"./TaskDisplay":38,"./UserInterface":39}],41:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
var Color = (function () {
    ...
    Color.prototype.HtmlColour = function () {
...
"use strict";
exports.__esModule = true;
exports.UnlimitedTimer = exports.LimitedTimer = exports.Timer = void 0;
var Timer_1 = require("./time/Timer");
exports.Timer = Timer_1.Timer;
var LimitedTimer_1 = require("./time/LimitedTimer");
exports.LimitedTimer = LimitedTimer_1.LimitedTimer;
var UnlimitedTimer_1 = require("./time/UnlimitedTimer");
exports.UnlimitedTimer = UnlimitedTimer_1.UnlimitedTimer;
},{"./time/LimitedTimer":43,"./time/Timer":44,"./time/UnlimitedTimer":45}],43:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
exports.__esModule = true;
exports.LimitedTimer = void 0;
var Timer_1 = require("./Timer");
var LimitedTimer = (function (_super) {
    __extends(LimitedTimer, _super);
    function LimitedTimer(task, duration) {
        var _this = _super.call(this) || this;
        _this.task = task;
        _this.duration = duration;
        return _this;
    }
    LimitedTimer.prototype.Tick = function () {
        if (this.Progress() >= 100) {
            this.task.Complete();
        }
    };
    LimitedTimer.prototype.Progress = function () {
        var progress = this.startTime == 0 ? 0 : (this.ElapsedTime() / this.duration) * 100;
...
},{"./Timer":44}],44:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
exports.__esModule = true;
exports.UnlimitedTimer = void 0;
var Timer_1 = require("./Timer");
var UnlimitedTimer = (function (_super) {
    __extends(UnlimitedTimer, _super);
    function UnlimitedTimer() {
        return _super.call(this) || this;
    }
    UnlimitedTimer.prototype.Tick = function () {
    };
    UnlimitedTimer.prototype.Progress = function () {
        return 0;
    };
    return UnlimitedTimer;
}(Timer_1.Timer));
exports.UnlimitedTimer = UnlimitedTimer;
},{"./Timer":44}],46:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
exports.__esModule = true;
exports.ImageOption = void 0;
var Option_1 = require("./Option");
var ImageOption = (function (_super) {
    __extends(ImageOption, _super);
    function ImageOption(id, imageSrc) {
        var _this = _super.call(this, id, "") || this;
        _this.imageSrc = imageSrc;
        return _this;
    }
    ImageOption.prototype.Template = function () {
...
},{"./Option":47}],47:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
var Task = (function () {
    function Task() {
        var _this = this;
        this.resolve = function (result) { return null; };
        this.reject = function (reason) { return null; };
        ...
        this.title = "";
        this.prompt = "";
        this.timer = new metrics_1.UnlimitedTimer();
    ...
    Task.prototype.Error = function (reason) {
        this.reject(reason);
    };
    Task.prototype.SetDisplay = function (display) {
        this.display = display;
    };
    Task.prototype.GetDisplay = function () {
        return this.display;
    };
    ...
    Task.prototype.SetPrompt = function (prompt) {
        this.prompt = prompt;
    };
    Task.prototype.GetPrompt = function () {
        return this.prompt;
    };
    ...
    Task.prototype.SetCofidenceTracked = function (track) {
        this.trackConfidence = track;
    };
    Task.prototype.IsConfidenceTracked = function () {
        return this.trackConfidence;
    };
    Task.prototype.SetExplicitSubmissionRequired = function (submit) {
        this.explicitSubmissionRequired = submit;
    };
    Task.prototype.IsExplicitSubmissionRequired = function () {
        return this.explicitSubmissionRequired;
    };
    Task.prototype.SetResultsTracked = function (track) {
        this.trackResults = track;
    };
    Task.prototype.IsResultsTracked = function () {
        return this.trackResults;
    };
    return Task;
}());
exports.Task = Task;
var NoDisplay = (function (_super) {
    __extends(NoDisplay, _super);
    function NoDisplay() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    NoDisplay.prototype.Display = function (screen) {
    };
    return NoDisplay;
}(io_1.TaskDisplay));
},{"../io":40,"../metrics":42,"./TaskResult":50}],49:[function(require,module,exports){
"use strict";
exports.__esModule = true;
exports.TaskList = void 0;
var TaskList = (function () {
    function TaskList(tests) {
        this.currentIndex = 0;
        this.tests = tests;
    }
...
"use strict";
exports.__esModule = true;
exports.TaskList = exports.Task = exports.TaskResult = exports.ImageOption = exports.Option = void 0;
var Option_1 = require("./Option");
exports.Option = Option_1.Option;
var ImageOption_1 = require("./ImageOption");
exports.ImageOption = ImageOption_1.ImageOption;
var TaskResult_1 = require("./TaskResult");
exports.TaskResult = TaskResult_1.TaskResult;
var Task_1 = require("./Task");
exports.Task = Task_1.Task;
var TaskList_1 = require("./TaskList");
exports.TaskList = TaskList_1.TaskList;
},{"./ImageOption":46,"./Option":47,"./Task":48,"./TaskList":49,"./TaskResult":50}],52:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
var tasks_1 = require("../../tasks");
var PieChartDisplay_1 = require("./PieChartDisplay");
var PieChart = (function (_super) {
    __extends(PieChart, _super);
    function PieChart(originalData, compareData) {
        var _this = this;
        ...
        _this.SetDisplay(new PieChartDisplay_1.PieChartDisplay(_this.originalData, _this.compareData));
        return _this;
    }
    PieChart.prototype.Submit = function (selectedOptions) {
        this.Complete();
    };
    PieChart.prototype.GetOptions = function () {
        return [new tasks_1.Option(0, "Yes"), new tasks_1.Option(1, "No")];
    };
    return PieChart;
}(tasks_1.Task));
exports.PieChart = PieChart;
},{"../../tasks":51,"./PieChartDisplay":54}],53:[function(require,module,exports){
"use strict";
exports.__esModule = true;
exports.PieChartData = void 0;
var PieChartData = (function () {
    function PieChartData(label, value, colour) {
        this.Label = label;
        this.Value = value;
        this.Colour = colour;
    }
...
exports.__esModule = true;
exports.PieChartDisplay = void 0;
var d3 = require("d3");
var io_1 = require("../../io");
var IdGenerator_1 = require("../../util/IdGenerator");
var PieChartDisplay = (function (_super) {
    __extends(PieChartDisplay, _super);
    function PieChartDisplay(data, compareData) {
        var _this = _super.call(this) || this;
        _this.originalData = data;
        _this.comparedata = compareData;
        return _this;
    }
    PieChartDisplay.prototype.Display = function (screen) {
    ...
    PieChartDisplay.prototype.displayPie = function (container, drawData) {
        var containerId = IdGenerator_1.IdGenerator.Generate();
        ...
        var values = drawData.map(function (d) { return d.Value; });
...
},{"../../io":40,"../../util/IdGenerator":55,"d3":32}],55:[function(require,module,exports){
"use strict";
exports.__esModule = true;
